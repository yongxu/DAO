...
> **全 256 cell 逐格枚举请见** [`表六_256格全表.md`](../../六表_实虚史真/表六_256格全表.md) **§ 4** — 256 行 (#1..#256, 按象限 + King Wen 序 + Shi 序), 每行含 King Wen #, 卦名, 内/外卦 Trigram, 6-yao OX 串, Shi (道/已/未/今), (因, 果), 8-char OX 字面量, 简称 (`卦·时`)。
...
| Shi V₄ {道, 已, 今, 未} (R₈ side) | [`Cell256.lean`](../../formal/SSBX/Foundation/Bagua/Cell256.lean) `abbrev Shi := YinBit × GuoBit` (Phase C, 2026-05-11) + 4 个 `@[match_pattern] def` (dao/ji/jin/wei) |
