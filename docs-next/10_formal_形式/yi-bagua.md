...
192 格的根树见 [../_generated/cell192-tree-index.md](../_generated/cell192-tree-index.md)：根节点逐层分出六个爻位，闭合为 64 卦，再配 已/今/未 三时态成为 192 个叶子。

192 格的一跳转移表见 [../_generated/cell192-transition-index.md](../_generated/cell192-transition-index.md)。它把每个 `Cell192` 位点列成一行，并给出六个爻翻转、时态前进/后退、错、综、互各自到达的目标位。
