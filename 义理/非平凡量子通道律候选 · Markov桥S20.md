...
本轮闭合范围：**finite support-respecting quantum-channel skeleton 的非平凡非零通道律**。S21 已把 Born rule 的 one-qubit computational-basis 版本接到显式 measurement weights；S22 进一步把 finite action branch 接到 action amplitude、normalized qubit 与 measurement-event weights。
