...
| 真实干涉、真实 quantum channel law、物理 Born rule 语义 | 未纳入本轮 | S5/S5b/S5c/S5d/S5e/S5f/S5g/S5h/S5i/S5j/S5k/S5l/S5m/S5n/S5o/S5p/S5q/S5r 与 S13-S18 已开候选接口；还需要真正关闭 unitary/CPTP、连续相位/作用量动力学、amplitude dynamics、measurement postulate semantics、decoherence、general choice function、general all-path enumeration、一般 path integral 或可测预言 theorem |
