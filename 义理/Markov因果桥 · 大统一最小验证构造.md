...
| 真实干涉、physical Hilbert/unitary/CPTP/Kraus/density-matrix channel law、一般测量语义 | 未纳入本轮 | S5/S5b/S5c/S5d/S5e/S5f/S5g/S5h/S5i/S5j/S5k/S5l/S5m/S5n/S5o/S5p/S5q/S5r 与 S13-S24 已开候选接口；还需要真正关闭 Hilbert/unitary/CPTP/Kraus/density-matrix、一般 Hilbert measurement、POVM/PVM、general path-space action functional、stochastic semantics、general Hamiltonian/unitary amplitude dynamics、measurement postulate semantics、decoherence、general choice function、general all-path enumeration、一般 path integral 或可测预言 theorem |
...
| 轴 | 状态 | 说明 |
|---|---|---|
| amplitude dynamics 与物理测量语义 | 未纳入本轮 | S23 已关闭 finite period-two phase operation，S24 已关闭 displayed continuous action-coordinate sampling；仍未证明 Hamiltonian generator、continuous-time unitary group、general Schrödinger dynamics、measurement postulate semantics、decoherence 或无条件物理测量概率律 |
...
| 真实干涉律 | 未纳入本轮 | S5/S5b/S5c/S5d/S5e/S5f/S5g/S5h/S5i/S5j/S5k/S5l/S5m/S5n/S5o/S5p/S5q/S5r 与 S24 有相消 witness、非零候选 path witness、two-path finite cancellation candidate、discrete phase-label candidate、edge-action phase accumulation candidate、finite path-family sum candidate、finite path-sum algebra candidate、endpoint-indexed finite family candidate、endpoint support normalization candidate、two-route toy enumeration candidate、visible path-key candidate、finite visible-key quotient candidate、visible-key quotient class candidate、two-route canonical representative candidate、finite quotient-support candidate、quotient-support algebra candidate、pending observable ledger boundary、finite action-to-phase law candidate 与 displayed continuous action-coordinate functional；没有 general path-space action functional、general choice function、general all-path enumeration、一般 path integral、continuous-time dynamics 或可测预言 theorem |
...
| 真实干涉律 | general path-space action functional、一般 path integral、continuous-time dynamics 与可测相消 | 未纳入本轮 |
...
-> general path-space action functional / 一般 path integral / 真实干涉律 / 真实 channel law
-> 几何与经验接口
```
