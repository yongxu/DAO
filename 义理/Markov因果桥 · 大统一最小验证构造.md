...
| 真实干涉、physical Hilbert/unitary/CPTP/Kraus/density-matrix channel law、一般测量语义 | 未纳入本轮 | S5/S5b/S5c/S5d/S5e/S5f/S5g/S5h/S5i/S5j/S5k/S5l/S5m/S5n/S5o/S5p/S5q/S5r 与 S13-S21 已开候选接口；还需要真正关闭 Hilbert/unitary/CPTP/Kraus/density-matrix、一般 Hilbert measurement、POVM/PVM、连续相位/作用量动力学、stochastic semantics、amplitude dynamics、measurement postulate semantics、decoherence、general choice function、general all-path enumeration、一般 path integral 或可测预言 theorem |
...
| 一般 Hilbert measurement / POVM / PVM | 未纳入本轮 | S21 只关闭 one-qubit computational-basis normalized-state weights；未引入一般 Hilbert carrier、projection-valued measures 或 positive operator-valued measures |
