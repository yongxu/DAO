...
| Born rule 从 Markov / 振幅桥的推导 | 未纳入本轮 | S17 不证明无条件振幅平方律推导或物理测量概率律 |
| 真实干涉、真实 quantum channel law、Born rule 推导 | 未纳入本轮 | S5/S5b/S5c/S5d/S5e/S5f/S5g/S5h/S5i/S5j/S5k/S5l/S5m/S5n/S5o/S5p/S5q/S5r 与 S13-S17 已开候选接口；还需要真正关闭 unitary/CPTP、连续相位/作用量动力学、general choice function、general all-path enumeration、一般 path integral、可测预言 theorem 或 Markov 到 Born 的推导 |
...
| 轴 | 状态 | 说明 |
|---|---|---|
| Born rule 从 Markov 桥的推导 | 未纳入本轮 | S17 已关闭 unitary/CPTP ledger boundary；仍未从振幅结构推出无条件物理测量概率律 |
