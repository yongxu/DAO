...
| 真实干涉、physical Hilbert/unitary/CPTP/Kraus/density-matrix channel law、一般测量语义 | 未纳入本轮 | S5/S5b/S5c/S5d/S5e/S5f/S5g/S5h/S5i/S5j/S5k/S5l/S5m/S5n/S5o/S5p/S5q/S5r 与 S13-S23 已开候选接口；还需要真正关闭 Hilbert/unitary/CPTP/Kraus/density-matrix、一般 Hilbert measurement、POVM/PVM、连续相位/作用量动力学、stochastic semantics、general Hamiltonian/unitary amplitude dynamics、measurement postulate semantics、decoherence、general choice function、general all-path enumeration、一般 path integral 或可测预言 theorem |
...
| 轴 | 状态 | 说明 |
|---|---|---|
| amplitude dynamics 与物理测量语义 | 未纳入本轮 | S23 已关闭 finite period-two phase operation；仍未证明 Hamiltonian generator、continuous-time unitary group、general Schrödinger dynamics、measurement postulate semantics、decoherence 或无条件物理测量概率律 |
