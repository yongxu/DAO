...
| Born rule 从 Markov / 振幅桥的推导 | 未纳入本轮 | S16 不证明无条件振幅平方律推导或物理测量概率律 |
| 真实干涉、真实 quantum channel law、Born rule 推导 | 未纳入本轮 | S5/S5b/S5c/S5d/S5e/S5f/S5g/S5h/S5i/S5j/S5k/S5l/S5m/S5n/S5o/S5p/S5q/S5r 与 S13-S16 已开候选接口；还需要 unitary/CPTP、连续相位/作用量动力学、general choice function、general all-path enumeration、一般 path integral、可测预言 theorem 或 Markov 到 Born 的推导 |
...
| 轴 | 状态 | 说明 |
|---|---|---|
| Born rule 从 Markov 桥的推导 | 未纳入本轮 | S16 已关闭 composed Born boundary；仍未从振幅结构推出无条件物理测量概率律 |
| 路径权重乘法定律 | 未纳入本轮 | `pathWeight` 可先作为接口占位 |
| 非平凡量子通道律 | 未纳入本轮 | S4 有 candidate skeleton，S13-S16 已有 pointwise composition、associativity/identity obstruction、sum-over-middle boundary 与 composed Born boundary；没有 unitary evolution、CPTP、Kraus 或 density-matrix law |
