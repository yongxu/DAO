...
| Born rule 从 Markov / 振幅桥的推导 | 未纳入本轮 | S11 不证明无条件振幅平方律推导或物理测量概率律 |
...
| 轴 | 状态 | 说明 |
|---|---|---|
| Born rule 从 Markov 桥的推导 | 未纳入本轮 | S11 已关闭 conditional finite Born-weight law；仍未从振幅结构推出无条件物理测量概率律 |
