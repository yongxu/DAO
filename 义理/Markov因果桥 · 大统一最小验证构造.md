...
| 真实干涉、physical Hilbert/unitary/CPTP/Kraus/density-matrix channel law、一般测量语义 | 未纳入本轮 | S5/S5b/S5c/S5d/S5e/S5f/S5g/S5h/S5i/S5j/S5k/S5l/S5m/S5n/S5o/S5p/S5q/S5r 与 S13-S22 已开候选接口；还需要真正关闭 Hilbert/unitary/CPTP/Kraus/density-matrix、一般 Hilbert measurement、POVM/PVM、连续相位/作用量动力学、stochastic semantics、完整 amplitude dynamics、measurement postulate semantics、decoherence、general choice function、general all-path enumeration、一般 path integral 或可测预言 theorem |
...
| 轴 | 状态 | 说明 |
|---|---|---|
| amplitude dynamics 与物理测量语义 | 未纳入本轮 | S18 已关闭 Markov/amplitude compatibility 下的 finite typed-skeleton derivation；仍未证明 amplitude construction from dynamics、measurement postulate semantics、decoherence 或无条件物理测量概率律 |
| 一般 Hilbert measurement / POVM / PVM | 未纳入本轮 | S21/S22 只关闭 one-qubit computational-basis normalized-state weights 与 finite action branch 接入；未引入一般 Hilbert carrier、projection-valued measures 或 positive operator-valued measures |
