...
CLI_CASES = [
    ...
    (["--coverage"], "semantic ledger: 371 theorem-backed / 209 exact / 162 exact-structural-helper / 0 structural-carrier / 0 catalogue-normal-form"),
    (["--coverage"], "domain gaps: 162 operators pending full domain semantics"),
    (["--coverage"], "domain gap ledger: 8 application-helper / 0 identity-noop / 71 projection-anchor / 83 carrier-constructor / 0 predicate-anchor / 0 truth-marker / 0 catalogue-shape"),
    ...
    (["--operators", "exact"], "operators exact: 209 shown; 371 registered / 371 executable"),
    (["--operators", "exact-structural-helper"], "operators exact-structural-helper: 162 shown; 371 registered / 371 executable"),
    ...
    (["--operators", "application-helper-only"], "operators application-helper-only: 8 shown; 371 registered / 371 executable"),
    (["--operators", "carrier-constructor-only"], "operators carrier-constructor-only: 83 shown; 371 registered / 371 executable"),
    ...
    (["--help"], "371 theorem-backed bodies = 209 exact + 162 exact structural helpers + 0 structural carriers; 0 catalogue normal forms"),
]
...
JSON_CLI_CASES = [
    ...
    (["--json", "--coverage"], {
        ...
        "exactTheoremBackedOperators": 209,
        "exactStructuralHelperOperators": 162,
        "structuralCarrierOperators": 0,
        "catalogueNormalFormOperators": 0,
        "domainGapOperators": 162,
        "domainGapApplicationHelperOperators": 8,
        "domainGapIdentityNoopOperators": 0,
        "domainGapProjectionAnchorOperators": 71,
        "domainGapCarrierConstructorOperators": 83,
