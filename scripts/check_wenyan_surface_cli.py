...
QIAN_PAIR_VALUE = {"idx": 0, "label": " («乾»)"}
E2_QIAN_QIAN_VALUE = {
    "kind": "hexPair",
    "values": [QIAN_PAIR_VALUE, QIAN_PAIR_VALUE],
}
...
CASES = [
    ...
    ("一 同 一", {"ok": True, "kind": "bool", "value": True}),
    ("推 乾 同 一", {"ok": True, "kind": "bool", "value": True}),
    ("（推 乾） 同 一", {"ok": True, "kind": "bool", "value": True}),
    ("乾 比 坤", {"ok": True, "kind": "bool", "value": False}),
    ...
    ("者 甲 甲 真", {"ok": True, "kind": "bool", "value": True}),
    ("者 甲 不 甲 真", {"ok": True, "kind": "bool", "value": False}),
    ("（者 甲 不 甲） 之 真", {"ok": True, "kind": "bool", "value": False}),
    ("（者 甲 甲 之 乾） 之 推", {"ok": True, "kind": "hex", "idx": 1}),
    ("（者 甲 甲 之 一） 之 推", {"ok": True, "kind": "hex", "idx": 2}),
    ("（者 甲 甲 之 真） 之 不", {"ok": True, "kind": "bool", "value": False}),
    ("令 甲 真 不 甲", {"ok": True, "kind": "bool", "value": False}),
    ("令 甲 （推） （甲 之 乾）", {"ok": True, "kind": "hex", "idx": 1}),
    ("令 甲 （不） （甲 之 真）", {"ok": True, "kind": "bool", "value": False}),
    ("各 者 甲 真 者 甲 同 甲 甲", {"ok": True, "kind": "bool", "value": True}),
    ...
    ("治 乾 坤", {"ok": True, "kind": "hexPair", "values": [{"idx": 0, "label": " («乾»)"}, {"idx": 63, "label": " («坤»)"}]}),
    ("术 乾 坤", {"ok": True, "kind": "hexPair", "values": [{"idx": 0, "label": " («乾»)"}, {"idx": 63, "label": " («坤»)"}]}),
    ...
    ("曰 乾 乾", {"ok": True, **E2_QIAN_QIAN_VALUE}),
    ("教 乾 坤 一", {"ok": True, "kind": "hexList", "values": [{"idx": 0, "label": " («乾»)"}, {"idx": 63, "label": " («坤»)"}, {"idx": 1, "label": " («一»)"}]}),
]
...
NEGATIVE_CASES = [
    ...
    ("反", {"phase": "resolve", "code": "ambiguous_reading", "surface": "反", "startCol": 0, "endCol": 1, "candidateCount": 3}),
    ("或 乾", {"phase": "resolve", "code": "ambiguous_reading", "surface": "或", "startCol": 0, "endCol": 1, "candidateCount": 2}),
...
CLI_CASES = [
    ...
    (["--typecheck", "者 甲 甲"], "type (Hex -> Hex)"),
    (["--typecheck", "者 甲 不 甲"], "type (Bool -> Bool)"),
    (["--typecheck", "者 甲 同 甲 甲"], "type (Hex -> Bool)"),
    (["--typecheck", "者 甲 甲 之 乾"], "type ((Hex -> Hex) -> Hex)"),
    (["--typecheck", "者 甲 甲 之 真"], "type ((Bool -> Bool) -> Bool)"),
    (["--typecheck", "者 甲 甲 推"], "type (Hex -> Hex)"),
    (["--typecheck", "而 者 甲 甲 者 甲 推 甲"], "type (Hex -> Hex)"),
    (["--typecheck", "而 反 推"], "type (Hex -> Hex)"),
    (["--typecheck", "而 推 反"], "type (Hex -> Hex)"),
    (["--typecheck", "再 反"], "type (Hex -> Hex)"),
    ...
    (["--compile-yi", "而 反 综"], "yi program: [zong, cuo, halt]"),
    (["--compile-yi", "再 反"], "yi program: [cuo, cuo, halt]"),
    ...
    (["--operator", "R-6"], "domain law: identity-noop-law"),
    ...
    (["--operator", "S-4"], "executable note: 若: Bool identity marker; no discourse semantics"),
    (["--operator", "S-4"], "domain law: truth-marker-law"),
    ...
    (["--operator", "T-3"], "domain law: directed-relation"),
    ...
    (["--operator", "Y-6"], "domain law: medicine-frame-accessor"),
    ...
    (["--operator", "A-1"], "domain law: aspect-marker-accessor"),
    ...
    (["--operator", "H-1"], "domain law: name-object-accessor"),
    ...
    (["--operator", "Z-26"], "domain law: divination-cognition-accessor"),
    ...
    (["--operator", "A-16"], "semantic strength: exact-theorem-backed"),
    ...
    (["--operator", "E-1"], "domain law: institution-frame-accessor"),
    ...
    (["--operator", "E-2"], "executable note: 曰: text-act pair carrier; no speech-act/content semantics"),
    (["--operator", "E-2"], "carrier kind: pair-carrier"),
    (["--operator", "E-2"], "domain law: naming-measure-relation"),
    (["曰 乾 乾"], "pair (idx 0 («乾»)) (idx 0 («乾»))"),
    (["--operator", "R-12"], "semantic strength: exact-theorem-backed"),
    (["--operator", "R-12"], "carrier kind: pair-carrier"),
    (["--operator", "R-12"], "domain law: pair-relation-core"),
    (["--operator", "D-4"], "semantic strength: exact-theorem-backed"),
    (["--operator", "D-4"], "carrier kind: duplicate-facet"),
    (["--operator", "X-14"], "semantic strength: exact-theorem-backed"),
    (["--operator", "X-14"], "carrier kind: binary-aggregate"),
    (["--operator", "X-16"], "executable note: 教: education state-transition ternary carrier; no pedagogy transition law"),
    (["--operator", "X-16"], "carrier kind: ternary-aggregate"),
    (["--operator", "Z-18"], "semantic strength: exact-theorem-backed"),
    (["--operator", "Z-18"], "carrier kind: list-projection"),
    (["--operator", "S-1"], "semantic strength: exact-theorem-backed"),
    (["--operator", "S-1"], "carrier kind: application-carrier"),
    (["--operator", "S-1"], "domain law: application-wrapper-law"),
    (["--operator", "S-15"], "semantic strength: exact-theorem-backed"),
    (["--operator", "S-15"], "executable note: 于/於: finite Hex context predicate application"),
    (["--operator", "B-8"], "domain law: predicate-anchor-law"),
    (["于 同 乾 乾"], "bool true"),
    (["地 同 乾 坤"], "bool false"),
    (["--operator", "K-6"], "semantic strength: exact-theorem-backed"),
    ...
    (["--coverage"], "semantic ledger: 371 theorem-backed / 371 exact / 0 exact-structural-helper / 0 structural-carrier / 0 catalogue-normal-form"),
    (["--coverage"], "domain gaps: 0 operators without exact executable mechanics"),
    (["--coverage"], "domain gap ledger: 0 application-helper / 0 identity-noop / 0 projection-anchor / 0 carrier-constructor / 0 predicate-anchor / 0 truth-marker / 0 catalogue-shape"),
    (["--coverage"], "domain caveats: 0 exact carrier/anchor rows without full domain laws"),
    (["--coverage"], "domain laws: 364 carrier/anchor rows with typed domain laws"),
    (["--coverage"], "domain caveat ledger: 0 application / 0 identity-noop / 0 projection / 0 pair / 0 duplicate / 0 singleton / 0 binary / 0 ternary / 0 list-projection / 0 predicate / 0 truth-marker"),
    (["--coverage"], "catalogue-shape ledger: 0 state-transition / 0 domain-process / 0 domain-rule / 0 assignment / 0 trajectory / 0 debind / 0 response / 0 modifier / 0 protocol / 0 signal / 0 binding / 0 decomposer / 0 partition / 0 text-act"),
    ...
    (["--operators", "theorem-backed"], "operators theorem-backed: 371 shown; 371 registered / 371 executable"),
    (["--operators", "exact"], "operators exact: 371 shown; 371 registered / 371 executable"),
    (["--operators", "exact-structural-helper"], "operators exact-structural-helper: 0 shown; 371 registered / 371 executable"),
    (["--operators", "structural-carrier"], "operators structural-carrier: 0 shown; 371 registered / 371 executable"),
    (["--operators", "catalogue-normal-form"], "operators catalogue-normal-form: 0 shown; 371 registered / 371 executable"),
    (["--operators", "identity-noop"], "operators identity-noop: 20 shown; 371 registered / 371 executable"),
    ...
    (["--operators", "application-helper-only"], "operators application-helper-only: 0 shown; 371 registered / 371 executable"),
    (["--operators", "carrier-constructor-only"], "operators carrier-constructor-only: 0 shown; 371 registered / 371 executable"),
    (["--operators", "domain-caveat"], "operators domain-caveat: 0 shown; 371 registered / 371 executable"),
    (["--operators", "domain-law"], "operators domain-law: 364 shown; 371 registered / 371 executable"),
    (["--operators", "domain-law"], "domain-law="),
    (["--operators", "catalogue-shape-only"], "operators catalogue-shape-only: 0 shown; 371 registered / 371 executable"),
    (["--operators", "ternary-aggregate"], "operators ternary-aggregate: 4 shown; 371 registered / 371 executable"),
    ...
    (["--help"], "371 theorem-backed bodies = 371 exact + 0 exact structural helpers + 0 structural carriers; 0 catalogue normal forms"),
]
...
JSON_CLI_CASES = [
    ...
    (["--json", "--typecheck", "而 反 推"], {"mode": "typecheck", "type": "(Hex -> Hex)"}),
    (["--json", "--typecheck", "而 推 反"], {"mode": "typecheck", "type": "(Hex -> Hex)"}),
    (["--json", "--typecheck", "再 反"], {"mode": "typecheck", "type": "(Hex -> Hex)"}),
    (["--json", "--typecheck", "于 同 乾 乾"], {"mode": "typecheck", "type": "Bool"}),
    (["--json", "于 同 乾 乾"], {"kind": "bool", "value": True}),
    (["--json", "--compile-yi", "错"], {
        "mode": "compile-yi",
        "type": "(Hex -> Hex)",
        "program": ["cuo", "halt"],
    ...
    (["--json", "--operator", "Y-2"], {
        ...
        "domainLawKind": "medical-cosmological-aggregate",
    }),
    (["--json", "--operator", "I-1"], {
        "mode": "operator",
        "operatorCode": "I-1",
    ...
    (["--json", "--operator", "R-12"], {
        ...
        "domainGapKind": None,
        "domainCaveatKind": None,
        "domainLawKind": "pair-relation-core",
    }),
    (["--json", "--operator", "S-1"], {
        "mode": "operator",
        "operatorCode": "S-1",
        ...
        "domainGapKind": None,
        "domainCaveatKind": None,
        "domainLawKind": "application-wrapper-law",
    }),
    ...
    (["--json", "--operators", "catalogue-normal-form"], {
        ...
        "operatorsRegistered": 371,
        "executableOperators": 371,
        "catalogueNormalFormOperators": 0,
    }),
    ...
    (["--json", "--operators", "domain-caveat"], {
        "mode": "operators",
        "filter": "domain-caveat",
        "count": 0,
        "operatorsRegistered": 371,
        "executableOperators": 371,
        "domainCaveatOperators": 0,
    }),
    (["--json", "--operators", "domain-law"], {
        "mode": "operators",
        "filter": "domain-law",
        "count": 364,
        "operatorsRegistered": 371,
    ...
    (["--json", "--coverage"], {
        ...
        "operatorsRegistered": 371,
        "executableOperators": 371,
        "theoremBackedOperators": 371,
        "exactTheoremBackedOperators": 371,
        "exactStructuralHelperOperators": 0,
        "structuralCarrierOperators": 0,
        "catalogueNormalFormOperators": 0,
        "domainGapOperators": 0,
        "domainGapApplicationHelperOperators": 0,
        "domainGapIdentityNoopOperators": 0,
        "domainGapProjectionAnchorOperators": 0,
        "domainGapCarrierConstructorOperators": 0,
        "domainGapPredicateAnchorOperators": 0,
        "domainGapTruthMarkerOperators": 0,
        "domainGapCatalogueShapeOperators": 0,
        "domainCaveatOperators": 0,
        "domainLawOperators": 364,
        "domainCaveatApplicationOperators": 0,
        "domainCaveatIdentityNoopOperators": 0,
        "domainCaveatProjectionAnchorOperators": 0,
        "domainCaveatPairCarrierOperators": 0,
        "domainCaveatDuplicateFacetOperators": 0,
        "domainCaveatSingletonAggregateOperators": 0,
        "domainCaveatBinaryAggregateOperators": 0,
        "domainCaveatTernaryAggregateOperators": 0,
        "domainCaveatListProjectionOperators": 0,
        "domainCaveatPredicateOperators": 0,
        "domainCaveatTruthMarkerOperators": 0,
        "catalogueShapeStateTransitionOperators": 0,
        "catalogueShapeDomainProcessOperators": 0,
        "catalogueShapeDomainRuleOperators": 0,
        "catalogueShapeAssignmentOperators": 0,
        "catalogueShapeTrajectoryOperators": 0,
        "catalogueShapeDebindOperators": 0,
        "catalogueShapeResponseOperators": 0,
        "catalogueShapeModifierOperators": 0,
        "catalogueShapeProtocolOperators": 0,
        "catalogueShapeSignalOperators": 0,
        "catalogueShapeBindingOperators": 0,
        "catalogueShapeDecomposerOperators": 0,
        "catalogueShapePartitionOperators": 0,
        "catalogueShapeTextActOperators": 0,
        "baguaBridgeableOperators": 134,
