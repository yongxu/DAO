...
CLI_CASES = [
    ...
    (["--operator", "D-4"], "semantic strength: exact-structural-helper"),
    ...
    (["--operator", "Z-18"], "semantic strength: exact-structural-helper"),
    ...
    (["--coverage"], "semantic ledger: 371 theorem-backed / 128 exact / 243 exact-structural-helper / 0 structural-carrier / 0 catalogue-normal-form"),
    (["--coverage"], "domain gaps: 243 operators pending full domain semantics"),
    (["--coverage"], "domain gap ledger: 10 application-helper / 18 identity-noop / 102 projection-anchor / 104 carrier-constructor / 9 predicate-anchor / 0 truth-marker / 0 catalogue-shape"),
    ...
    (["--operators", "exact"], "operators exact: 128 shown; 371 registered / 371 executable"),
    (["--operators", "exact-structural-helper"], "operators exact-structural-helper: 243 shown; 371 registered / 371 executable"),
    ...
    (["--operators", "carrier-constructor-only"], "operators carrier-constructor-only: 104 shown; 371 registered / 371 executable"),
    ...
    (["--help"], "371 theorem-backed bodies = 128 exact + 243 exact structural helpers + 0 structural carriers; 0 catalogue normal forms"),
]
...
JSON_CLI_CASES = [
    ...
    (["--json", "--operator", "R-12"], {
        ...
        "domainGapKind": "carrier-constructor-only",
    }),
    (["--json", "--operator", "S-1"], {
        "mode": "operator",
        "operatorCode": "S-1",
    ...
    (["--json", "--coverage"], {
        ...
        "exactTheoremBackedOperators": 128,
        "exactStructuralHelperOperators": 243,
        ...
        "domainGapCarrierConstructorOperators": 104,
