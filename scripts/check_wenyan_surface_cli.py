...
CLI_CASES = [
    ...
    (["--coverage"], "semantic ledger: 367 theorem-backed / 122 exact / 245 exact-structural-helper / 0 structural-carrier / 4 catalogue-normal-form"),
    (["--coverage"], "domain gaps: 249 operators pending full domain semantics"),
    (["--coverage"], "domain gap ledger: 12 application-helper / 18 identity-noop / 102 projection-anchor / 100 carrier-constructor / 9 predicate-anchor / 4 truth-marker / 4 catalogue-shape"),
    (["--coverage"], "catalogue-shape ledger: 2 state-transition / 0 domain-process / 0 domain-rule / 0 assignment / 2 trajectory / 0 debind / 0 response / 0 modifier / 0 protocol / 0 signal / 0 binding / 0 decomposer / 0 partition / 0 text-act"),
    ...
    (["--operators", "theorem-backed"], "operators theorem-backed: 367 shown; 371 registered / 371 executable"),
    (["--operators", "exact"], "operators exact: 122 shown; 371 registered / 371 executable"),
    (["--operators", "exact-structural-helper"], "operators exact-structural-helper: 245 shown; 371 registered / 371 executable"),
    (["--operators", "structural-carrier"], "operators structural-carrier: 0 shown; 371 registered / 371 executable"),
    (["--operators", "catalogue-normal-form"], "operators catalogue-normal-form: 4 shown; 371 registered / 371 executable"),
    ...
    (["--operators", "carrier-constructor-only"], "operators carrier-constructor-only: 100 shown; 371 registered / 371 executable"),
    (["--operators", "carrier-constructor-only"], "gap=carrier-constructor-only"),
    (["--operators", "catalogue-shape-only"], "operators catalogue-shape-only: 4 shown; 371 registered / 371 executable"),
    ...
    (["--help"], "367 theorem-backed bodies = 122 exact + 245 exact structural helpers + 0 structural carriers; 4 catalogue normal forms"),
]
...
JSON_CLI_CASES = [
    ...
    (["--json", "--operators", "catalogue-normal-form"], {
        ...
        "operatorsRegistered": 371,
        "executableOperators": 371,
        "catalogueNormalFormOperators": 4,
    }),
    ...
    (["--json", "--coverage"], {
        ...
        "operatorsRegistered": 371,
        "executableOperators": 371,
        "theoremBackedOperators": 367,
        "exactTheoremBackedOperators": 122,
        "exactStructuralHelperOperators": 245,
