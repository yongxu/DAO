...
CLI_CASES = [
    ...
    (["--coverage"], "semantic ledger: 317 theorem-backed / 120 exact / 86 exact-structural-helper / 111 structural-carrier / 54 catalogue-normal-form"),
    ...
    (["--operators", "exact-structural-helper"], "operators exact-structural-helper: 86 shown; 371 registered / 371 executable"),
    (["--operators", "structural-carrier"], "operators structural-carrier: 111 shown; 371 registered / 371 executable"),
...
JSON_CLI_CASES = [
    ...
    (["--json", "--coverage"], {
        ...
        "exactStructuralHelperOperators": 86,
        "structuralCarrierOperators": 111,
        "catalogueNormalFormOperators": 54,
        "domainGapOperators": 251,
        ...
        "domainGapCatalogueShapeOperators": 54,
        "baguaBridgeableOperators": 134,
