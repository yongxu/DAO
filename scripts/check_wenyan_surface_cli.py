...
CLI_CASES = [
    ...
    (["--operator", "A-16"], "semantic strength: exact-structural-helper"),
    ...
    (["--operator", "E-2"], "domain gap: carrier-constructor-only"),
    ...
    (["--operator", "X-14"], "semantic strength: exact-structural-helper"),
    ...
    (["--operator", "S-1"], "semantic strength: exact-structural-helper"),
    (["--operator", "S-1"], "carrier kind: application-carrier"),
    (["--operator", "S-1"], "domain gap: application-helper-only"),
    ...
    (["于 同 乾 乾"], "bool true"),
    (["地 同 乾 坤"], "bool false"),
    (["--operator", "K-6"], "semantic strength: exact-structural-helper"),
    ...
    (["--coverage"], "semantic ledger: 371 theorem-backed / 143 exact / 228 exact-structural-helper / 0 structural-carrier / 0 catalogue-normal-form"),
    (["--coverage"], "domain gaps: 228 operators pending full domain semantics"),
    (["--coverage"], "domain gap ledger: 10 application-helper / 18 identity-noop / 102 projection-anchor / 89 carrier-constructor / 9 predicate-anchor / 0 truth-marker / 0 catalogue-shape"),
    ...
    (["--operators", "exact"], "operators exact: 143 shown; 371 registered / 371 executable"),
    (["--operators", "exact-structural-helper"], "operators exact-structural-helper: 228 shown; 371 registered / 371 executable"),
    ...
    (["--operators", "application-helper-only"], "operators application-helper-only: 10 shown; 371 registered / 371 executable"),
    (["--operators", "carrier-constructor-only"], "operators carrier-constructor-only: 89 shown; 371 registered / 371 executable"),
    ...
    (["--help"], "371 theorem-backed bodies = 143 exact + 228 exact structural helpers + 0 structural carriers; 0 catalogue normal forms"),
]
...
JSON_CLI_CASES = [
    ...
    (["--json", "--operator", "S-1"], {
        ...
        "semanticStrength": "exact-structural-helper",
        "domainGapKind": "application-helper-only",
    }),
    ...
    (["--json", "--coverage"], {
        ...
        "exactTheoremBackedOperators": 143,
        "exactStructuralHelperOperators": 228,
        "structuralCarrierOperators": 0,
        "catalogueNormalFormOperators": 0,
        "domainGapOperators": 228,
        "domainGapApplicationHelperOperators": 10,
        "domainGapIdentityNoopOperators": 18,
        "domainGapProjectionAnchorOperators": 102,
        "domainGapCarrierConstructorOperators": 89,
        "domainGapPredicateAnchorOperators": 9,
