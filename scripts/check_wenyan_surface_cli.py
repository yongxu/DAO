...
CLI_CASES = [
    ...
    (["--coverage"], "semantic ledger: 330 theorem-backed / 122 exact / 208 exact-structural-helper / 0 structural-carrier / 41 catalogue-normal-form"),
    (["--coverage"], "domain gaps: 249 operators pending full domain semantics"),
    (["--coverage"], "domain gap ledger: 12 application-helper / 18 identity-noop / 102 projection-anchor / 63 carrier-constructor / 9 predicate-anchor / 4 truth-marker / 41 catalogue-shape"),
    (["--coverage"], "catalogue-shape ledger: 2 state-transition / 8 domain-process / 6 domain-rule / 4 assignment / 4 trajectory / 3 debind / 3 response / 2 modifier / 2 protocol / 2 signal / 1 binding / 1 decomposer / 1 partition / 2 text-act"),
    ...
    (["--operators", "theorem-backed"], "operators theorem-backed: 330 shown; 371 registered / 371 executable"),
    (["--operators", "exact"], "operators exact: 122 shown; 371 registered / 371 executable"),
    (["--operators", "exact-structural-helper"], "operators exact-structural-helper: 208 shown; 371 registered / 371 executable"),
    (["--operators", "structural-carrier"], "operators structural-carrier: 0 shown; 371 registered / 371 executable"),
    (["--operators", "catalogue-normal-form"], "operators catalogue-normal-form: 41 shown; 371 registered / 371 executable"),
    ...
    (["--operators", "carrier-constructor-only"], "operators carrier-constructor-only: 63 shown; 371 registered / 371 executable"),
    (["--operators", "carrier-constructor-only"], "gap=carrier-constructor-only"),
    (["--operators", "catalogue-shape-only"], "operators catalogue-shape-only: 41 shown; 371 registered / 371 executable"),
    ...
    (["--help"], "330 theorem-backed bodies = 122 exact + 208 exact structural helpers + 0 structural carriers; 41 catalogue normal forms"),
]
...
JSON_CLI_CASES = [
    ...
    (["--json", "--operators", "catalogue-normal-form"], {
        ...
        "operatorsRegistered": 371,
        "executableOperators": 371,
        "catalogueNormalFormOperators": 41,
    }),
    ...
    (["--json", "--coverage"], {
        ...
        "operatorsRegistered": 371,
        "executableOperators": 371,
        "theoremBackedOperators": 330,
        "exactTheoremBackedOperators": 122,
        "exactStructuralHelperOperators": 208,
        ...
        "domainGapCarrierConstructorOperators": 63,
        "domainGapPredicateAnchorOperators": 9,
        "domainGapTruthMarkerOperators": 4,
        "domainGapCatalogueShapeOperators": 41,
        "catalogueShapeStateTransitionOperators": 2,
        "catalogueShapeDomainProcessOperators": 8,
