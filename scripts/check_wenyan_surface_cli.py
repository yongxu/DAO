...
CLI_CASES = [
    ...
    (["--coverage"], "semantic ledger: 319 theorem-backed / 122 exact / 197 exact-structural-helper / 0 structural-carrier / 52 catalogue-normal-form"),
    (["--coverage"], "domain gaps: 249 operators pending full domain semantics"),
    (["--coverage"], "domain gap ledger: 12 application-helper / 18 identity-noop / 102 projection-anchor / 52 carrier-constructor / 9 predicate-anchor / 4 truth-marker / 52 catalogue-shape"),
    (["--coverage"], "catalogue-shape ledger: 13 state-transition / 8 domain-process / 6 domain-rule / 4 assignment / 4 trajectory / 3 debind / 3 response / 2 modifier / 2 protocol / 2 signal / 1 binding / 1 decomposer / 1 partition / 2 text-act"),
    ...
    (["--operators", "theorem-backed"], "operators theorem-backed: 319 shown; 371 registered / 371 executable"),
    ...
    (["--operators", "catalogue-normal-form"], "operators catalogue-normal-form: 52 shown; 371 registered / 371 executable"),
    ...
    (["--operators", "catalogue-shape-only"], "operators catalogue-shape-only: 52 shown; 371 registered / 371 executable"),
    ...
    (["--help"], "319 theorem-backed bodies = 122 exact + 197 exact structural helpers + 0 structural carriers; 52 catalogue normal forms"),
]
...
JSON_CLI_CASES = [
    ...
    (["--json", "--operators", "catalogue-normal-form"], {
        ...
        "operatorsRegistered": 371,
        "executableOperators": 371,
        "catalogueNormalFormOperators": 52,
    }),
    ...
    (["--json", "--coverage"], {
        ...
        "domainGapCarrierConstructorOperators": 52,
        "domainGapPredicateAnchorOperators": 9,
        "domainGapTruthMarkerOperators": 4,
        "domainGapCatalogueShapeOperators": 52,
        "catalogueShapeStateTransitionOperators": 13,
