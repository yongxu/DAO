...
CLI_CASES = [
    ...
    (["--operator", "E-2"], "domain caveat: pair-carrier"),
    ...
    (["--coverage"], "domain caveats: 249 exact carrier/anchor rows without full domain laws"),
    (["--coverage"], "domain caveat ledger: 12 application / 20 identity-noop / 100 projection / 67 pair / 13 duplicate / 17 singleton / 2 binary / 4 ternary / 1 list-projection / 9 predicate / 4 truth-marker"),
    ...
    (["--operators", "domain-caveat"], "operators domain-caveat: 249 shown; 371 registered / 371 executable"),
    (["--operators", "domain-caveat"], "caveat="),
...
JSON_CLI_CASES = [
    ...
    (["--json", "--operator", "S-1"], {
        ...
        "semanticStrength": "exact-theorem-backed",
        "domainGapKind": None,
        "domainCaveatKind": "application-carrier",
    }),
    ...
    (["--json", "--coverage"], {
        ...
        "domainCaveatOperators": 249,
        "domainCaveatApplicationOperators": 12,
        "domainCaveatIdentityNoopOperators": 20,
        "domainCaveatProjectionAnchorOperators": 100,
        "domainCaveatPairCarrierOperators": 67,
        "domainCaveatDuplicateFacetOperators": 13,
        "domainCaveatSingletonAggregateOperators": 17,
        "domainCaveatBinaryAggregateOperators": 2,
        "domainCaveatTernaryAggregateOperators": 4,
        "domainCaveatListProjectionOperators": 1,
        "domainCaveatPredicateOperators": 9,
        "domainCaveatTruthMarkerOperators": 4,
