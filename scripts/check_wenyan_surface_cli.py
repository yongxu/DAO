...
CLI_CASES = [
    ...
    (["--coverage"], "semantic ledger: 371 theorem-backed / 122 exact / 249 exact-structural-helper / 0 structural-carrier / 0 catalogue-normal-form"),
    (["--coverage"], "domain gaps: 249 operators pending full domain semantics"),
    (["--coverage"], "domain gap ledger: 12 application-helper / 18 identity-noop / 102 projection-anchor / 104 carrier-constructor / 9 predicate-anchor / 4 truth-marker / 0 catalogue-shape"),
    ...
    (["--operators", "exact"], "operators exact: 122 shown; 371 registered / 371 executable"),
    (["--operators", "exact-structural-helper"], "operators exact-structural-helper: 249 shown; 371 registered / 371 executable"),
    ...
    (["--help"], "371 theorem-backed bodies = 122 exact + 249 exact structural helpers + 0 structural carriers; 0 catalogue normal forms"),
]
...
JSON_CLI_CASES = [
    ...
    (["--json", "--coverage"], {
        ...
        "exactTheoremBackedOperators": 122,
        "exactStructuralHelperOperators": 249,
        ...
        "domainGapTruthMarkerOperators": 4,
