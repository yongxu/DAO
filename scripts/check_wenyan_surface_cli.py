...
CLI_CASES = [
    ...
    (["--coverage"], "semantic ledger: 317 theorem-backed / 120 exact / 197 structural-carrier / 54 catalogue-normal-form"),
    ...
    (["--operators", "structural-carrier"], "operators structural-carrier: 197 shown; 371 registered / 371 executable"),
    (["--operators", "catalogue-normal-form"], "operators catalogue-normal-form: 54 shown; 371 registered / 371 executable"),
    (["--help"], "wenyan-surface --json --operators [all|executable|theorem-backed|exact|structural|structural-carrier|catalogue-normal-form|bridgeable|known-not-executable|unsupported]"),
    (["--help"], "wenyan-surface --json --compile-yi <PROGRAM>"),
    (["--help"], "317 theorem-backed bodies = 120 exact + 197 structural carriers; 54 catalogue normal forms"),
]
...
JSON_CLI_CASES = [
    ...
    (["--json", "--coverage"], {
        ...
        "structuralCarrierOperators": 197,
        "catalogueNormalFormOperators": 54,
        "baguaBridgeableOperators": 134,
