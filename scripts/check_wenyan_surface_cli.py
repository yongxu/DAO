...
CLI_CASES = [
    ...
    (["--coverage"], "domain laws: 249 carrier/anchor rows with typed domain laws"),
    ...
    (["--operators", "domain-law"], "operators domain-law: 249 shown; 371 registered / 371 executable"),
