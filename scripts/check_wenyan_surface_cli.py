...
CLI_CASES = [
    ...
    (["--coverage"], "semantic ledger: 317 theorem-backed / 120 exact / 34 exact-structural-helper / 163 structural-carrier / 54 catalogue-normal-form"),
    ...
    (["--operators", "exact-structural-helper"], "operators exact-structural-helper: 34 shown; 371 registered / 371 executable"),
    (["--operators", "structural-carrier"], "operators structural-carrier: 163 shown; 371 registered / 371 executable"),
    ...
    (["--help"], "317 theorem-backed bodies = 120 exact + 34 exact structural helpers + 163 structural carriers; 54 catalogue normal forms"),
]
...
JSON_CLI_CASES = [
    ...
    (["--json", "--coverage"], {
        ...
        "exactStructuralHelperOperators": 34,
        "structuralCarrierOperators": 163,
        "catalogueNormalFormOperators": 54,
        "baguaBridgeableOperators": 134,
