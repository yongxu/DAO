...
CLI_CASES = [
    ...
    (["--coverage"], "semantic ledger: 338 theorem-backed / 122 exact / 216 exact-structural-helper / 0 structural-carrier / 33 catalogue-normal-form"),
    (["--coverage"], "domain gaps: 249 operators pending full domain semantics"),
    (["--coverage"], "domain gap ledger: 12 application-helper / 18 identity-noop / 102 projection-anchor / 71 carrier-constructor / 9 predicate-anchor / 4 truth-marker / 33 catalogue-shape"),
    (["--coverage"], "catalogue-shape ledger: 2 state-transition / 0 domain-process / 6 domain-rule / 4 assignment / 4 trajectory / 3 debind / 3 response / 2 modifier / 2 protocol / 2 signal / 1 binding / 1 decomposer / 1 partition / 2 text-act"),
    ...
    (["--operators", "theorem-backed"], "operators theorem-backed: 338 shown; 371 registered / 371 executable"),
    (["--operators", "exact"], "operators exact: 122 shown; 371 registered / 371 executable"),
    (["--operators", "exact-structural-helper"], "operators exact-structural-helper: 216 shown; 371 registered / 371 executable"),
    (["--operators", "structural-carrier"], "operators structural-carrier: 0 shown; 371 registered / 371 executable"),
    (["--operators", "catalogue-normal-form"], "operators catalogue-normal-form: 33 shown; 371 registered / 371 executable"),
    ...
    (["--operators", "carrier-constructor-only"], "operators carrier-constructor-only: 71 shown; 371 registered / 371 executable"),
    (["--operators", "carrier-constructor-only"], "gap=carrier-constructor-only"),
    (["--operators", "catalogue-shape-only"], "operators catalogue-shape-only: 33 shown; 371 registered / 371 executable"),
    ...
    (["--help"], "338 theorem-backed bodies = 122 exact + 216 exact structural helpers + 0 structural carriers; 33 catalogue normal forms"),
]
...
JSON_CLI_CASES = [
    ...
    (["--json", "--operators", "catalogue-normal-form"], {
        ...
        "operatorsRegistered": 371,
        "executableOperators": 371,
        "catalogueNormalFormOperators": 33,
    }),
    ...
    (["--json", "--coverage"], {
        ...
        "operatorsRegistered": 371,
        "executableOperators": 371,
        "theoremBackedOperators": 338,
        "exactTheoremBackedOperators": 122,
        "exactStructuralHelperOperators": 216,
        ...
        "domainGapCarrierConstructorOperators": 71,
        "domainGapPredicateAnchorOperators": 9,
        "domainGapTruthMarkerOperators": 4,
        "domainGapCatalogueShapeOperators": 33,
        "catalogueShapeStateTransitionOperators": 2,
        "catalogueShapeDomainProcessOperators": 0,
        "catalogueShapeDomainRuleOperators": 6,
        "catalogueShapeAssignmentOperators": 4,
        "catalogueShapeTrajectoryOperators": 4,
        "catalogueShapeDebindOperators": 3,
        "catalogueShapeResponseOperators": 3,
        "catalogueShapeModifierOperators": 2,
        "catalogueShapeProtocolOperators": 2,
        "catalogueShapeSignalOperators": 2,
        "catalogueShapeBindingOperators": 1,
        "catalogueShapeDecomposerOperators": 1,
        "catalogueShapePartitionOperators": 1,
        "catalogueShapeTextActOperators": 2,
        "baguaBridgeableOperators": 134,
