...
CLI_CASES = [
    ...
    (["--operator", "E-2"], "executable note: residual Hex carrier package"),
    (["--operator", "X-11"], "executable note: residual Hex carrier package"),
    (["--operator", "E-2"], "semantics support: theorem-backed"),
    ...
    (["--coverage"], "theorem-backed semantics: 371"),
    (["--coverage"], "structural catalogue fallback: 0"),
    ...
    (["--help"], "371 exact/theorem-backed; 0 structural catalogue"),
...
JSON_CLI_CASES = [
    ...
    (["--json", "--operators", "executable"], {
        ...
        "structuralCatalogueOperators": 0,
    }),
