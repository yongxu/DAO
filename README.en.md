...
| Claim | File |
|---|---|
| Cell256 = R₈ = (Z/2)⁸ concrete realisation, full 256 enumeration | `formal/SSBX/Foundation/Bagua/Cell256.lean § Cell256.all_length, mem_all` |
...
| Micro-kernel «加 + 一» — two-character closure | `formal/SSBX/Foundation/Yi/YiCore.lean` |
| 12-instr ISA Turing completeness + dao-judge | `formal/SSBX/Foundation/Bagua/BaguaTuring.lean` + `GodelLi.lean` |
