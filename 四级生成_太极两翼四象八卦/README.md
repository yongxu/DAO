...
| [J_理之不完备_哥德尔在192.md](J_理之不完备_哥德尔在192.md) | 道理二分 · Halting 不可判 · 192=最小 TC 层 | GodelLi.lean 32 定理 / 1 公理 (Kleene 递归) / 0 sorry / lake build 通过 |
...
| [M_证明报告_192_理之不完备.md](M_证明报告_192_理之不完备.md) | J 之 Lean 形式化报告（与 H 并列）· 七层结果 · 公理诚实陈述 | GodelLi.lean 32 定理 / 1 公理 / 0 sorry / 复现命令 |
