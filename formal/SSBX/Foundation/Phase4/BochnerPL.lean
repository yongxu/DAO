...
Companion: `四级生成_太极两翼四象八卦/动力 · 从元到行.md` (动衍 · Bochner 篇)
...
namespace SSBX.Foundation.Phase4.BochnerPL

open Real Set MeasureTheory Metric
open SSBX.Foundation.Phase4.PicardLindelofGen
open SSBX.Foundation.Phase4.ODESmoothness
...
end SSBX.Foundation.Phase4.BochnerPL
