...
Companion: `四级生成_太极两翼四象八卦/类与映 · 从元到映.md` § 米田续

`Phase4/CatExt.lean` § 6 已 anchor 协变 Hom 函子 `homFunctor C A : Functor C SetCat`，
...
namespace SSBX.Foundation.Phase4.YonedaFull
...
end SSBX.Foundation.Phase4.YonedaFull
