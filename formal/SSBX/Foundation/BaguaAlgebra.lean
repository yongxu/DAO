...
namespace SSBX.Foundation.BaguaAlgebra
...
theorem orbit_qian :
    apply id  qian = SSBX.Foundation.Yi.Trigram.qian ∧
    apply d   qian = SSBX.Foundation.Yi.Trigram.xun  ∧
    apply h   qian = SSBX.Foundation.Yi.Trigram.li   ∧
    apply b   qian = SSBX.Foundation.Yi.Trigram.dui  ∧
    apply dh  qian = SSBX.Foundation.Yi.Trigram.gen  ∧
    apply hb  qian = SSBX.Foundation.Yi.Trigram.zhen ∧
    apply db  qian = SSBX.Foundation.Yi.Trigram.kan  ∧
    apply dhb qian = SSBX.Foundation.Yi.Trigram.kun :=
...
end SSBX.Foundation.BaguaAlgebra
