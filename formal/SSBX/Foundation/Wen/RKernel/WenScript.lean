/-
# Wen.RKernel.WenScript -- controlled wen proof script over V4/R5
...
def ofView (view : R5View) : R5Word :=
  let ben :=
    V4.elim view.first BenWord.thing BenWord.interval BenWord.motion BenWord.event
  let zheng :=
    V4.elim view.second ZhengWord.trace ZhengWord.pivot ZhengWord.momentum ZhengWord.occasion
