...
theorem wenSurface_operator_catalogue_counts :
    fullOperatorSignatures.length = 371
      ...
      ∧ exactTheoremBackedStrongOperatorIds.length = 128
      ∧ exactStructuralHelperStrongOperatorIds.length = 243
      ...
      ∧ (domainGapKindOperatorIds .carrierConstructorOnly).length = 104
