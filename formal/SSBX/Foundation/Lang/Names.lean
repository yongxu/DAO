...
def army : Hexagram := Hexagram.mk .yin .yang .yin .yin .yin .yin
def uniting : Hexagram := Hexagram.mk .yin .yin .yin .yin .yang .yin
def smallRestraint : Hexagram := Hexagram.mk .yang .yang .yang .yin .yang .yang
def treading : Hexagram := Hexagram.mk .yang .yang .yin .yang .yang .yang
def fellowship : Hexagram := Hexagram.mk .yang .yin .yang .yang .yang .yang
def greatPossession : Hexagram := Hexagram.mk .yang .yang .yang .yang .yin .yang
def modesty : Hexagram := Hexagram.mk .yin .yin .yang .yin .yin .yin
def enthusiasm : Hexagram := Hexagram.mk .yin .yin .yin .yang .yin .yin
def following : Hexagram := Hexagram.mk .yang .yin .yin .yang .yang .yin
def decay : Hexagram := Hexagram.mk .yin .yang .yang .yin .yin .yang
def approach : Hexagram := Hexagram.mk .yang .yang .yin .yin .yin .yin
def contemplation : Hexagram := Hexagram.mk .yin .yin .yin .yin .yang .yang
def biteThrough : Hexagram := Hexagram.mk .yang .yin .yin .yang .yin .yang
def adornment : Hexagram := Hexagram.mk .yang .yin .yang .yin .yin .yang
def stripping : Hexagram := Hexagram.mk .yin .yin .yin .yin .yin .yang
def returning : Hexagram := Hexagram.mk .yang .yin .yin .yin .yin .yin
def innocence : Hexagram := Hexagram.mk .yang .yin .yin .yang .yang .yang
def greatRestraint : Hexagram := Hexagram.mk .yang .yang .yang .yin .yin .yang
def nourishing : Hexagram := Hexagram.mk .yang .yin .yin .yin .yin .yang
def greatExceeding : Hexagram := Hexagram.mk .yin .yang .yang .yang .yang .yin
def abyss : Hexagram := Hexagram.mk .yin .yang .yin .yin .yang .yin  -- 坎 卦 (29) — H suffix to avoid clash with Trigram.water
def brightness : Hexagram := Hexagram.mk .yang .yin .yang .yang .yin .yang  -- 离 卦 (30)
def influence : Hexagram := Hexagram.mk .yin .yin .yang .yang .yang .yin
def duration : Hexagram := Hexagram.mk .yin .yang .yang .yang .yin .yin
def retreat : Hexagram := Hexagram.mk .yin .yin .yang .yang .yang .yang
def greatPower : Hexagram := Hexagram.mk .yang .yang .yang .yang .yin .yin
def progress : Hexagram := Hexagram.mk .yin .yin .yin .yang .yin .yang
def darkening : Hexagram := Hexagram.mk .yang .yin .yang .yin .yin .yin
def family : Hexagram := Hexagram.mk .yang .yin .yang .yin .yang .yang
def opposition : Hexagram := Hexagram.mk .yang .yang .yin .yang .yin .yang
def obstruction : Hexagram := Hexagram.mk .yin .yin .yang .yin .yang .yin
def deliverance : Hexagram := Hexagram.mk .yin .yang .yin .yang .yin .yin
def decrease : Hexagram := Hexagram.mk .yang .yang .yin .yin .yin .yang
def increase : Hexagram := Hexagram.mk .yang .yin .yin .yin .yang .yang
def resolution : Hexagram := Hexagram.mk .yang .yang .yang .yang .yang .yin
def encounter : Hexagram := Hexagram.mk .yin .yang .yang .yang .yang .yang
def gathering : Hexagram := Hexagram.mk .yin .yin .yin .yang .yang .yin
def ascending : Hexagram := Hexagram.mk .yin .yang .yang .yin .yin .yin
def impasse : Hexagram := Hexagram.mk .yin .yang .yin .yang .yang .yin
def well : Hexagram := Hexagram.mk .yin .yang .yang .yin .yang .yin
def revolution : Hexagram := Hexagram.mk .yang .yin .yang .yang .yang .yin
def cauldron : Hexagram := Hexagram.mk .yin .yang .yang .yang .yin .yang
def arousing : Hexagram := Hexagram.mk .yang .yin .yin .yang .yin .yin  -- 震 卦 (51)
def keepingStill : Hexagram := Hexagram.mk .yin .yin .yang .yin .yin .yang  -- 艮 卦 (52)
def gradualProgress : Hexagram := Hexagram.mk .yin .yin .yang .yin .yang .yang
def marryingMaiden : Hexagram := Hexagram.mk .yang .yang .yin .yang .yin .yin
def abundance : Hexagram := Hexagram.mk .yang .yin .yang .yang .yin .yin
def wanderer : Hexagram := Hexagram.mk .yin .yin .yang .yang .yin .yang
def gentle : Hexagram := Hexagram.mk .yin .yang .yang .yin .yang .yang  -- 巽 卦 (57)
def joyous : Hexagram := Hexagram.mk .yang .yang .yin .yang .yang .yin  -- 兑 卦 (58)
def dispersion : Hexagram := Hexagram.mk .yin .yang .yin .yin .yang .yang
def limitation : Hexagram := Hexagram.mk .yang .yang .yin .yin .yang .yin
def innerTruth : Hexagram := Hexagram.mk .yang .yang .yin .yin .yang .yang
def smallExceeding : Hexagram := Hexagram.mk .yin .yin .yang .yang .yin .yin
