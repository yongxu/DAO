...
Markov 不是最终统一理论；它是最省力的第一块脚手架。它能把“过程、转移、路径、测量、事件、因果”放进同一个有限结构里。S4 已经把经典 Markov 层与量子振幅 / 通道候选层分开，S5 已经把 path amplitude、相消候选和 Born-shaped boundary 接上；下一步应在这个接口上处理非零路径动力学、真实干涉律、真实 channel law、因果集或几何极限。
...
- 保留边界：S5 使用 zero path-amplitude placeholder，不证明非零路径动力学、真实干涉律、Born rule 从 Markov 桥的推导、unitary/CPTP channel law、decoherence 或经验闭合。
