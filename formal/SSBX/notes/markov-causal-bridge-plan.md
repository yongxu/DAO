...
- 保留边界：S5k 只证明 visible path-key boundary；真正 quotient construction、proof-field path equality、general all-path enumeration、path integral、Born rule 推导、unitary/CPTP law、decoherence 与经验闭合作为后续结构。
