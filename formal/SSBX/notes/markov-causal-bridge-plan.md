...
- 保留边界：S5k 只证明 visible path-key boundary；finite visible-key quotient candidate 已由 S5l 承接，visible-key quotient class 已由 S5m 承接；proof-field path equality、canonical representative、general all-path enumeration、path integral、Born rule 推导、unitary/CPTP law、decoherence 与经验闭合作为后续结构。
...
- 保留边界：S5m 不证明 proof-field path equality、canonical representative、general all-path enumeration、path integral、Born rule 推导、unitary/CPTP law、decoherence 或经验闭合。
