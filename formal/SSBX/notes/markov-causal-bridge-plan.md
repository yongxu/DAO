...
- 保留边界：S5h 只证明 endpoint-indexed finite family conversion；all-path enumeration、filter / support normalization、path integral、Born rule 推导、unitary/CPTP law、decoherence 与经验闭合作为后续结构。
