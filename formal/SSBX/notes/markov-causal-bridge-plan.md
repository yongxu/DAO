...
- 保留边界：S5i 只证明给定 endpoint-indexed finite family 上的 filter / duplicate boundary；quotient 去重、all-path enumeration、path integral、Born rule 推导、unitary/CPTP law、decoherence 与经验闭合作为后续结构。
