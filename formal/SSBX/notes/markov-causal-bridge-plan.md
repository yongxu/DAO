...
- 保留边界：S5f 只证明 finite path-family sum candidate；arbitrary all-path enumeration、path-sum algebra、path integral、Born rule 推导、unitary/CPTP law、decoherence 与经验闭合作为后续结构。
