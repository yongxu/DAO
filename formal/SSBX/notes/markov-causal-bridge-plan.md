...
- 保留边界：S13 不证明 Born rule 推导、真实 quantum channel law、unitary/CPTP law、路径积分、度规恢复或经验闭合。
...
- 保留边界：S17 是 ledger boundary，不证明 physical unitary/CPTP channel law；它明确下一步需要新增 Hilbert/Kraus/density-matrix 等语义。
