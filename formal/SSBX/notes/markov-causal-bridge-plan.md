...
- [ ] 证明真实干涉律：general path-space action functional、一般 path integral、连续时间动力学与可测相消
...
- 保留边界：S5r 本身不证明 continuous action functional；displayed continuous action-coordinate functional 已由 S24 承接。general path-space action functional、Hamiltonian/unitary dynamics、path integral、Born rule 推导、数据校准或经验闭合仍需后续结构。
...
- 保留边界：S22 仍是 finite typed chain；S24 后续承接 displayed continuous action-coordinate functional。S22 本身不证明 general path-space action functional、Hamiltonian dynamics、unitary time evolution、general path integral、general Hilbert measurement、PVM/POVM、decoherence 或 empirical closure。
...
- 保留边界：S24 只证明 displayed continuous action-coordinate functional 的两个采样点；不证明 general path-space action functional、Euler-Lagrange equations、Hamiltonian generator、continuous-time unitary group、general Schrödinger dynamics、general path integral、general Hilbert measurement、PVM/POVM、decoherence 或 empirical closure。
