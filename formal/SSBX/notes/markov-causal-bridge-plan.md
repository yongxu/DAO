...
- 保留边界：S5g 只证明 finite list algebra over candidate amplitudes；all-path enumeration、filter / duplicate normalization、path integral、Born rule 推导、unitary/CPTP law、decoherence 与经验闭合作为后续结构。
