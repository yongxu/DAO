...
- 保留边界：S5j 只证明 two-route toy process 的 two-step middle enumeration；proof-field path equality、quotient 去重、general all-path enumeration、path integral、Born rule 推导、unitary/CPTP law、decoherence 与经验闭合作为后续结构。
