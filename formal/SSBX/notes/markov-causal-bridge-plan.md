...
- 保留边界：S27 只证明 finite one-step localFuture locality；不证明 full causal set axioms、local finite causal interval、light cone、Lorentzian manifold locality、metric recovery、relativistic field locality、smooth/infinite-dimensional path-space action functional、general path integral、measurement semantics、decoherence 或 empirical closure。
