...
import SSBX.Foundation.Bagua.R7  -- R5 中间层 (Hexagram × YinBit, 128 cells, 印 算子)
...
import SSBX.Foundation.Bagua.R8  -- R6 闭合层 (Hexagram × Shi V₄, 256 cells, 投 算子)
import SSBX.Foundation.Bagua.R8Stratify  -- R5/R6 双层 stratification + R6_complete bundle
