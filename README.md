...
| 主张 | 文件 |
|---|---|
| Cell256 = R₈ = (Z/2)⁸ 之具体实现, 256 全枚举 | `formal/SSBX/Foundation/Atlas/Yi/Classical/Bagua-cluster/Cell256.lean § Cell256.all_length, mem_all` |
...
| R8_complete bundle (R₀..R₈ 完整闭合, native_decide + propext) | `formal/SSBX/Foundation/Atlas/Yi/Classical/Bagua-cluster/Cell256Stratify.lean` |
| BenZheng: 4 本 / 4 征 / Mian = R₄ / Quadrant 4 象限 | `formal/SSBX/Foundation/Atlas/Yi/Classical/Bagua-cluster/BenZheng.lean` |
| 道-理二分 cross-cutting | `formal/SSBX/Foundation/Modern/DaoLi.lean` |
| 微核「加 + 一」 — 二字成核 | `formal/SSBX/Foundation/Atlas/Yi/Classical/YiCore.lean` |
| 12-instr ISA Turing 完备 + 道判机 | `formal/SSBX/Foundation/Atlas/Yi/Classical/Bagua-cluster/BaguaTuring.lean` + `GodelLi.lean` |
