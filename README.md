...
| L1 typed lambda (33 theorem-backed executable rows over 371-op catalogue) | `Foundation/Wen/WenDef.lean § Stdlib` + `Foundation/Wen/WenSurface/Semantics.lean § executableSemanticsFor?` |
